...
class UnifiedIngestionService:
    ...
    def ingest_documents(
        self, directory: str = "data/Stoneman_dispute/user_data", extensions: list[str] = None
    ) -> dict[str, Any]:
    ...
    def ingest_all(
        self, document_directory: str = "data/Stoneman_dispute/user_data", email_since: str = None
    ) -> dict[str, Any]:
        ...
        return {
            ...
            "totals": {"processed": total_processed, "errors": total_errors},
        }
