...
def reindex_collection(
    collection_name: str = "emails", batch_size: int = 100, dry_run: bool = False
):
    """
    ...
    while True:
        try:
            ...
            for point in points:
                ...
                new_point = PointStruct(id=new_id, vector=point.vector, payload=payload)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="Simulate reindexing without making changes"
    )
    ...
    if args.verify_only:
        ...
        reindexed, skipped, errors = reindex_collection(
            collection_name=args.collection, batch_size=args.batch_size, dry_run=args.dry_run
        )
