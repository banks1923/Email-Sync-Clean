...
def test_vector_store_connection():
    ...
    try:
        ...
        vs = get_vector_store()
        print(f"✅ Vector store wrapper connected")
...
def test_error_handling():
    ...
    try:
        from search.main import search, vector_store_available
        ...
        print(f"✅ Search works even with potential vector issues")
        print(f"   Results: {len(results)}")
