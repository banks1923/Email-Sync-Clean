...
class TestRankSnippets:
    ...
    def test_rank_snippets_position_bonus(self):
        ...
        """
        snippets = ["End of text has Python", "Python at the beginning"]
...
class TestFormatSearchResult:
    ...
    def test_format_search_result_body_field(self):
        ...
        """
        content = {"body": "Email body with search term.", "subject": "Test Email"}
    ...
    def test_format_search_result_title_fallback(self):
        ...
        """
        content = {"title": "Document with search term"}
    ...
    def test_format_search_result_ansi_highlighting(self):
        ...
        assert (
            "\033[93m" in result["highlighted_snippet"]
            or "[keyword]" in result["highlighted_snippet"]
        )
    ...
    def test_format_search_result_preserves_original(self):
        ...
        """
        content = {"content": "Original content", "id": 123, "metadata": {"key": "value"}}
