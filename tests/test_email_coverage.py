...
"""
    ...
    def test_merge_boundaries_overlap(self):
        ...
        boundaries = [
            MessageBoundary(
                start=0, end=5, boundary_type="original", confidence=0.9, marker="test1"
            ),
            MessageBoundary(start=3, end=8, boundary_type="quote", confidence=0.8, marker="test2"),
            MessageBoundary(
                start=6, end=10, boundary_type="forward", confidence=0.7, marker="test3"
            ),
        ]
...
Normal text"""
        ...
        result = self.deduplicator._parse_message_segment(content, "quoted", 0)
...
This is forwarded content."""
    ...
    def test_merge_boundaries_with_adjacent(self):
        ...
        boundaries = [
            ...
            MessageBoundary(start=5, end=10, boundary_type="quote", confidence=0.8, marker="test2"),
        ]
