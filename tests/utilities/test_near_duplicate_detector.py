...
class TestNearDuplicateDetector:
    ...
    def test_add_document(self):
        ...
        detector.add_document("doc1", "This is test content", {"author": "test"})
    ...
    def test_batch_deduplicate_with_metadata(self):
        ...
        documents = [
            {"id": "1", "content": "Document content", "metadata": {"source": "email"}},
            {"id": "2", "content": "Document content", "metadata": {"source": "file"}},
        ]
    ...
    def test_batch_deduplicate_auto_id(self):
        ...
        documents = [{"content": "Content without ID"}, {"content": "Another content without ID"}]
