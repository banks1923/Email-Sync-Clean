...
> John"""
        ...
        unique_count = self.db.fetch_one(
        ...
        occurrences = self.db.fetch_one(
            "SELECT COUNT(*) as count FROM message_occurrences"
        )
        ...
        self.assertEqual(content_count['count'], unique_count['count'], 
    ...
    def test_foreign_key_integrity(self):
        ...
        self.db.execute(
            "DELETE FROM individual_messages WHERE message_hash=?",
            ("test_integrity",)
        )
