...
def test_configuration_system():
    ...
    try:
        ...
        if auto_result["success"]:
            print(f"  ✓ Auto-configuration: {auto_result.get('message', 'Success')}")
        else:
            print(f"  ✗ Auto-configuration failed: {auto_result['error']}")
        
    except Exception as e:
        print(f"✗ TranscriptionService integration failed: {e}")
        return False
    ...
    try:
        ...
        if save_result["success"]:
            ...
            print(f"✗ Failed to save configuration: {save_result['error']}")
