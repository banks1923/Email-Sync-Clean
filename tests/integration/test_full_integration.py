...
def test_full_integration():
    ...
    before_count = db.fetch_one("SELECT COUNT(*) as count FROM content_unified WHERE source_type = 'email_message'")
    ...
    # Check results
    after_count = db.fetch_one("SELECT COUNT(*) as count FROM content_unified WHERE source_type = 'email_message'")
