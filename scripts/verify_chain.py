...
def print_verification_report(results):
    ...
    print(f"  Files with content without embedding: {results['docs_with_content_without_embedding']}")
    ...
    if results["content_without_embedding"] > 0:
        ...
        print(f"  - {results['docs_with_content_without_embedding']} docs with content but no embeddings")
        print()
